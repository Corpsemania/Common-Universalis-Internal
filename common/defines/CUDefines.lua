...
NDefines.NCountry.SETTLEMENT_GROWTH_DEVELOPMENT_INCREASE = 1000 -- How much development may increase per year if a colonist is working on Settlement Growth.
...
NDefines.NCountry.SETTLMENT_GROWTH_CHANCE_MIN = 0.01 -- Minimum chance of increasing development for colonists promoting Settlement Growth
NDefines.NCountry.SETTLEMENT_GROWTH_CHECK_INTERVAL = 3650000 -- Interval in days between checks for random development increase when working in Settlement Growth.
...
NDefines.NEconomy.HEAVY_SHIP_MAINT_FACTOR = 0.09
NDefines.NEconomy.LIGHT_SHIP_MAINT_FACTOR = 0.03
NDefines.NEconomy.GALLEY_MAINT_FACTOR = 0.03
NDefines.NEconomy.TRANSPORT_MAINT_FACTOR  = 0.02
...
NDefines.NMilitary.MIN_MONTHLY_MANPOWER = 0.001 --1 men/month is minimum.
NDefines.NMilitary.MAX_SAILORS	= 10	--Years in mp pool.
NDefines.NMilitary.MIN_MONTHLY_SAILORS = 1	--1 sailors/month is minimum.
NDefines.NMilitary.TRANSPORT_COST = 35
...
NDefines.NMilitary.GARRISON_SIZE = 200
NDefines.NMilitary.SIEGE_FORCE_NEEDED_MULTIPLIER = 5
...
NDefines.NMilitary.TRANSPORT_SPEED = 6.5
...
NDefines.NMilitary.REVOLUTIONARY_GUARD_MAXIMUM_RATIO = 0.0			-- Maximum number of Revolutionary Guard regiments, relative to force limit
--NMilitaryEnd
...
NDefines.NAI.ARTILLERY_FRACTION = 0.4
NDefines.NAI.INVADING_MAX_AWAY_RATIO = 0.5
NDefines.NAI.MIN_FORCE_LIMIT_SHARE_REGION_ASSIGN = 10
