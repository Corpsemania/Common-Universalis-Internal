...
NDefines.NCountry.CORRUPTION_COST = 0.02			-- cost for monthly combat per development
...
NDefines.NEconomy.DECREASE_AUTONOMY_MIN = 80
...
NDefines.NAI.CORRUPTION_BUDGET_FRACTION = 0.75
